...
const AddCakePage = lazy(() => import("./pages/admin/AddCakePage"));
const ManageCakesPage = lazy(() => import("./pages/admin/ManageCakesPage"));
                ...
                <div className="min-h-screen flex items-center justify-center bg-background">
                  <div className="flex flex-col items-center gap-4">
                    <div className="relative w-12 h-12">
                      ...
                      <div
                        className="absolute inset-2 rounded-full border-2 border-secondary border-b-transparent animate-spin"
                        style={{
